...
async function run() {
  ...
  try {
    ...
    // Obtener la lista de componentes importados pero no instalados
    ...
    // Si el archivo components.json no existe, inicializar shadcn
    ...
    // Si hay componentes instalables, instalarlos
    if (installableComponentNames.length && !error) {
      ...
      if (isErrorStatus) {
        ...
        // Ejemplo de salida de shadcnAddOutput:
        //   - src/components/ui/button.tsx
        //   - src/components/ui/input.tsx
        // El código abajo extrae estas rutas de archivo así: src/components/ui/button.tsx, src/components/ui/input.tsx
