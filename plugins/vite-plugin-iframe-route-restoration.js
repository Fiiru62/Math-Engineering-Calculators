export default function iframeRouteRestorationPlugin() {
	...
	// Comprobar si la página está dentro de un iframe
				...
				try {
					...
					if (current !== saved) {
						...
						requestAnimationFrame(() => setTimeout(() => {
							...
							// Si la ruta restaurada produce muy poco contenido, asumir que es inválida y navegar a la página principal
							if (text.length < 50) {
								replaceHistoryState('/');
							}
							} catch {}
